...
window.addEventListener('scroll',()=>{
    if(scrollY>50)
    {
        navBar.classList.add('bg-white', 'backdrop-blur-lg', 'bg-opacity-50', 'shadow-sm','dark:bg-black','dark:shadow-white/20')
        navLinks.classList.remove('bg-white','shadow-sm','bg-opacity-50','dark:border','dark:border-white/70','dark:transparent')
    }
    else{
        navBar.classList.remove('bg-white', 'backdrop-blur-lg', 'bg-opacity-50', 'shadow-sm','dark:bg-black','dark:shadow-white/20')
